      ...
      <div className="w-full flex items-start gap-x-6">
        ...
        <div className="border sticky top-10 hidden xl:block max-w-[400px] flex-1 bg-richblack-800 p-6 border-richblack-700 rounded-md">
          ...
          <ul className="ml-5 list-item list-disc space-y-4 text-xs text-richblack-5">
            ...
            <li>
              Add Topics in the Course Builder section to create your own
              lessons.
            </li>
            <li>
            ...
            <li>
              Make Sure to add the duration of the video in seconds to get the
              accurate info on your course.
            </li>
          </ul>
        </div>
      </div>
