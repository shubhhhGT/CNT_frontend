  ...
  const Timeline = [
    {
      ...
      Description: "Providing in-depth analysis and market trends.",
    },
    {
      Logo: Logo2,
      heading: "Risk Management",
      Description: "Teaching strategies to manage and mitigate risks.",
    },
    {
      Logo: Logo3,
      heading: "Investment Strategies",
      Description: "Equipping you with diverse investment strategies.",
    },
    {
      Logo: Logo4,
      heading: "Financial Growth",
      Description: "Helping you achieve financial growth and stability.",
    },
  ];
